...
InPortCorbaCdrConsumer.new = function()
	...
	function obj:subscribeFromIor(properties)
		...
		local _obj = orb:newproxy(ior,"IDL:openrtm.aist.go.jp/OpenRTM/InPortCdr:1.0")
	...
	function obj:unsubscribeFromIor(properties)
		...
		local Manager = require "openrtm.Manager"
		local orb = Manager:instance():getORB()
		local var = orb:newproxy(ior,"IDL:openrtm.aist.go.jp/OpenRTM/InPortCdr:1.0")
...
InPortCorbaCdrConsumer.InPortCorbaCdrConsumerInit = function()
